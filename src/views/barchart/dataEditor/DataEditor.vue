      ...
      <div class="seriesContainer">
        ...
        <div v-for="(series, seriesIndex) in seriesData" :key="seriesIndex" class="series-item">
          ...
          <div class="form-group">
            ...
            <input type="text" v-model="series.name" class="form-input" @input="updateSeriesData" />
          </div>
          <div class="form-group">
            <label class="form-label">颜色</label>
            <input type="color" v-model="series.color" class="color-input" @input="updateSeriesData" />
          </div>
          <div class="form-group">
