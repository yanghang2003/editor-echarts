...
//一进入这个页面就先判断是否要把折线图初始数据赋值给store
const store = useStore();
const newBarConfig = JSON.parse(JSON.stringify(DEFAULT_LINE_CHART_DATA));

store.state.editData.chartType && store.state.editData.chartType == 'line'
  ? console.log('不需要赋初始值')
